            ...
            sending ? (
              ...
              <View style={styles.quickQuestions}>
                ...
                {TAX_QUICK_QUESTIONS.map((q, i) => (
                  <TouchableOpacity key={i} style={styles.quickBtn} onPress={() => setInputText(q)}>
...
const styles = StyleSheet.create({
  ...
  userContent: { backgroundColor: '#ff9800', borderBottomRightRadius: 4 },
  ...
  quickBtn: {
    ...
    borderRadius: 12, marginBottom: 8, borderWidth: 1, borderColor: '#ffe0b2',
  },
  quickText: { fontSize: 14, color: '#ff9800' },
  inputBar: {
  ...
  sendBtnDisabled: { backgroundColor: '#ffe0b2' },
